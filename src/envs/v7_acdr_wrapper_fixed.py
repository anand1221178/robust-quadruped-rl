...
class V7ACDRWrapperFixed(gym.Wrapper):
    """
    ...
    def step(self, action):
        ...
        # V7.5 FIX: Use raw reward from info dict for curriculum adaptation
        # This avoids using the normalized reward from VecNormalize, which gives a
        # false performance signal and caused previous curriculum failures.
        self.episode_return += info.get('reward', reward)
